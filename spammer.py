		...
		def Main():
			...
			def main():
				...
				while True:
					...
					print(Fore.GREEN+("1) СМС спамер.")+Style.RESET_ALL)
					print(Fore.GREEN+("2) Обновить прокси.")+Style.RESET_ALL)
					print(Fore.GREEN+("3) Обновить СПАМЕР.")+Style.RESET_ALL)
